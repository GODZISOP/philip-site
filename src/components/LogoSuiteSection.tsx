...
export const LogoSuiteSection: React.FC = () => {
  ...
  return (
    <section id="brand-suite" className="py-24 bg-prime-950 relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-sm bg-prime-900 hover:bg-prime-850 border border-white/10 text-xs font-mono text-white transition-all"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-sm bg-gold-500 hover:bg-gold-400 text-xs font-mono font-bold text-prime-950 transition-all shadow-sm"
            >
              <Download className="w-3.5 h-3.5" />
        ...
        {/* Live Logo Variants Grid */}
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          
          {/* Card 1: Primary Full Wordmark Lockup */}
          <div
            className={`p-8 rounded-sm border transition-all duration-300 flex flex-col justify-between h-72 ${
              activeTheme === 'light'
        ...
        {/* Real-World Application Mockup Showcase */}
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          
          {/* Mockup 1: Mobile App Icon Preview */}
          <div className="p-7 rounded-sm bg-prime-900 border border-white/10 flex items-center gap-6">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-prime-850 via-prime-900 to-prime-950 border border-gold-500/40 shadow-2xl flex items-center justify-center shrink-0">
          ...
          <div className="p-7 rounded-sm bg-prime-900 border border-white/10 flex items-center gap-6">
            <div className="w-20 h-20 rounded-sm bg-[#121418] border border-white/5 shadow-inner flex items-center justify-center shrink-0 relative overflow-hidden">
